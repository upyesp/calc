...
const MESSAGES = {
  en: {
    ...
    "desktop-desc": "A native window around the same engine — installs like a regular application and shares saved functions and scripts with the CLI and TUI.",
    "pwa-name": "Web app",
  ...
  "zh-CN": {
    ...
    "desktop-name": "桌面应用",
    "desktop-desc": "同一引擎的原生窗口，像普通应用程序一样安装，并与 CLI 和 TUI 共享保存的函数和脚本。",
    "pwa-name": "网页应用",
  ...
  hi: {
    ...
    "desktop-desc": "उसी इंजन के चारों ओर एक मूल विंडो — सामान्य एप्लिकेशन की तरह इंस्टॉल होती है और CLI और TUI के साथ सहेजे गए फ़ंक्शन और स्क्रिप्ट साझा करती है।",
    "pwa-name": "वेब ऐप",
  ...
  es: {
    ...
    "desktop-desc": "Una ventana nativa alrededor del mismo motor: se instala como una aplicación normal y comparte funciones y scripts guardados con la CLI y la TUI.",
  ...
  fr: {
    ...
    "desktop-desc": "Une fenêtre native autour du même moteur — s'installe comme une application classique et partage fonctions et scripts enregistrés avec la CLI et la TUI.",
  ...
  ar: {
    ...
    "desktop-desc": "نافذة أصلية حول المحرك نفسه — تُثبَّت مثل أي تطبيق عادي وتشارك الدوال والنصوص البرمجية المحفوظة مع CLI وTUI.",
